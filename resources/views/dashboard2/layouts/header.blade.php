                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  ">
                                <a class="nav-item Language dropdown notification_dropdown " href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" x="0" y="0" viewBox="0 0 511.992 511.992" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="M195.472 250.163h-64.558c-1.989 0-3.897.79-5.303 2.197l-50.782 50.782c-.126.126-.269.27-.621.124s-.352-.348-.352-.526v-45.076a7.5 7.5 0 0 0-7.5-7.5h-8.07c-9.214 0-16.709-7.496-16.709-16.709V31.709C41.577 22.496 49.073 15 58.286 15H260.03c9.214 0 16.709 7.496 16.709 16.709v137.186a7.5 7.5 0 0 0 15 0V31.709C291.74 14.225 277.515 0 260.031 0H58.286C40.802 0 26.577 14.225 26.577 31.709v201.745c0 17.484 14.225 31.709 31.709 31.709h.57v37.576c0 6.32 3.772 11.966 9.611 14.385a15.532 15.532 0 0 0 16.968-3.375l48.585-48.585h61.452a7.5 7.5 0 0 0 0-15.001z" fill="#0023ff" opacity="1" data-original="#000000" class=""></path><path d="M453.705 193.675H251.961c-17.485 0-31.709 14.225-31.709 31.709v201.744c0 17.485 14.225 31.709 31.709 31.709h126.01l48.585 48.585a15.526 15.526 0 0 0 16.968 3.375 15.523 15.523 0 0 0 9.611-14.385v-37.576h.57c17.485 0 31.709-14.225 31.709-31.709V225.384c.001-17.485-14.224-31.709-31.709-31.709zm16.71 233.453c0 9.214-7.496 16.709-16.709 16.709h-8.07a7.5 7.5 0 0 0-7.5 7.5v45.076c0 .179 0 .381-.352.526-.351.147-.495.003-.621-.124l-50.782-50.782a7.497 7.497 0 0 0-5.303-2.197H251.961c-9.214 0-16.709-7.496-16.709-16.709V225.384c0-9.214 7.496-16.709 16.709-16.709h201.744c9.214 0 16.709 7.496 16.709 16.709v201.744zM169.056 63.267a10.574 10.574 0 0 0-9.893-6.779h-.011a10.573 10.573 0 0 0-9.809 6.593l-.067.17-51.512 135.254a7.5 7.5 0 1 0 14.017 5.338l10.99-28.855h72.415l4.79 12.694a7.5 7.5 0 1 0 14.034-5.296zm-40.572 96.722 30.661-80.502 30.38 80.502z" fill="#0023ff" opacity="1" data-original="#000000" class=""></path><path d="M388.564 385.905c-7.962 6.225-17.527 9.515-27.661 9.515-24.788 0-44.954-20.166-44.954-44.954s20.166-44.954 44.954-44.954h20.174a7.5 7.5 0 0 0 0-15h-24.209c-9.213 0-16.709-7.496-16.709-16.709s7.496-16.709 16.709-16.709c4.747 0 9.287 2.031 12.457 5.571 2.762 3.086 7.504 3.348 10.59.585s3.348-7.504.585-10.59a31.757 31.757 0 0 0-23.632-10.566c-17.484 0-31.709 14.225-31.709 31.709 0 8.899 3.69 16.948 9.614 22.713-20.002 9.728-33.823 30.254-33.823 53.95 0 33.059 26.895 59.954 59.954 59.954 13.514 0 26.274-4.391 36.899-12.697a7.5 7.5 0 0 0-9.239-11.818z" fill="#0023ff" opacity="1" data-original="#000000" class=""></path></g></svg>
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="index.html" class="dropdown-item ai-icon">
										...
										<svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" class="text-success" width="18" height="18" x="0" y="0" viewBox="0 0 24 24" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g><path d="M13.5 10h2v.8c.7-.5 1.5-.7 2.3-.8.8 0 1.6.1 2.3.5s1.3 1 1.7 1.7.6 1.5.6 2.3V20h-2v-5.5c0-1.4-1.2-2.5-2.5-2.5s-2.5 1.1-2.5 2.5V20h-2V10zm-2-6v2h-8v5h8v2h-8v5h8v2h-10V4z" fill="#d21818" opacity="1" data-original="#000000" class=""></path></g></svg>
                                        <button class="ms-2 rebutton" type="button">English</button>
                                    </a>
                                    ...
                                    <a href="indexRTL.html" class="dropdown-item ai-icon">
										<svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" class="text-danger" width="18" height="18" x="0" y="0" viewBox="0 0 512 512"  xml:space="preserve" ><g><path d="M318.2 187.9c-42.9 16.7-83.5 34.4-115.9 53.8-34.4 20.8-57.2 48.7-57.2 75.3 0 57.2 62.7 96.4 155.7 96.4 33.7 0 64.4-4.1 86.9-9.9l2.4 6.1c-17.4 13-36.1 26.2-57.2 38.2-10.9 6.1-31 9.9-58.3 9.9-82.8 0-152.7-39.2-152.7-127.1 0-44.6 23.9-81.4 56.6-110.1-36.8-26.2-51.1-44.6-51.1-74.3 0-14.7 5.1-34.8 15.3-52.1 15.7-25.9 38.9-39.9 63.4-39.9 30 0 52.5 15 73.3 42.9l-5.5 7.2c-17.7-8.2-34.8-11.2-52.8-11.2-37.8 0-68.1 19.1-68.1 33 0 15.3 8.9 27.6 29.6 43.3 12.3 8.9 29.3 18.4 36.1 18.4s12.9-3.4 18.7-6.1c30.7-14.6 61.3-27.9 92-39.5l1.7 1z" fill="#0f04e0" opacity="1" data-original="#000000" class=""></path></g></svg>
                                        <button class="ms-2 rebutton" id="rtlButton"  type="button">Arabic</button>
                                    </a>
                                </div>
                            </li>
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    <img src="{{ asset('assets/assets2/images/profile/pic1.jpg') }}" alt="">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a class="dropdown-item ai-icon" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
