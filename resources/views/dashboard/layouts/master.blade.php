            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown has-arrow">
                    ...
                    <div class="dropdown-menu">
                        ...
                        {{-- <form id="logoutt-form" action="{{ route('logoutt') }}" method="POST" style="display: none;">
                            @csrf
                        </form>
                        <a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('logoutt-form').submit();">
                            Logout
                        </a> --}}
