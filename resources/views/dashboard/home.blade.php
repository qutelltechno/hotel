                                ...
                                <table class="table table-hover table-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Email</th>
                                            <th>Room Name</th>
                                            <th class="text-center"> checkin_date</th>
                                            <th class="text-right">checkout_date</th>
                                    ...
                                    <tbody>
                                        @foreach ($Reservations as $Reservation)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div>{{ $Reservation->checkin_date }}</div>
                                                </td>
                                                <td class="text-right">
                                                    <div>{{ $Reservation->checkout_date }}</div>
                                                </td>
                                                <td class="text-center"> <span
                                                        class="badge badge-pill bg-success inv-badge">{{ $Reservation->status }}</span> </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
